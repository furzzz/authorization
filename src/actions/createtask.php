...
$query = "INSERT INTO `tasks` (`created_task_user_id`, `send_task_user_id`, `title`, `description`, `status`, `created_data`, `end_data`) VALUES (:createdTaskUserId, :sendTaskUserId, :title, :description, :status, :createdDate, :endDate)";
$params = [
